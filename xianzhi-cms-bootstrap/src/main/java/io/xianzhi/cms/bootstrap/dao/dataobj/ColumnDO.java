...
/**
 * Entity class for column data.
 * <p>
 * This class maps to the `xz_column` table in the database and represents
 * the persistent data structure for columns. It extends the {@link BaseDO}
