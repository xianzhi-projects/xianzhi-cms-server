...
/**
 * Entity class for field data.
 * <p>
 * This class maps to the `xz_field` table in the database and represents
 * the persistent data structure for fields. It extends the {@link BaseDO}
