...
/**
 * Entity class for form data.
 * <p>
 * This class maps to the `xz_form` table in the database and represents
 * the persistent data structure for forms. It extends the {@link BaseDO}
