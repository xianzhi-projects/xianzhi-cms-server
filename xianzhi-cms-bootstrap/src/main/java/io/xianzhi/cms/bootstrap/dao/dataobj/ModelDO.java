...
/**
 * Entity class for model data.
 * <p>
 * This class maps to the `xz_model` table in the database and represents
 * the persistent data structure for models. It extends the {@link BaseDO}
