 ...
 * <p>
 * This class maps to the `xz_order` table in the database and represents
 * the persistent data structure for orders. It extends the {@link BaseDO}
