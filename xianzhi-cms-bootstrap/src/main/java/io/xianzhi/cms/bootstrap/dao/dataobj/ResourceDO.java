...
/**
 * Entity class for resource data.
 * <p>
 * This class maps to the `xz_resource` table in the database and represents
 * the persistent data structure for resources. It extends the {@link BaseDO}
