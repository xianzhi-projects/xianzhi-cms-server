...
/**
 * Entity class for userRole data.
 * <p>
 * This class maps to the `xz_user_role` table in the database and represents
 * the persistent data structure for userRoles. It extends the {@link BaseDO}
